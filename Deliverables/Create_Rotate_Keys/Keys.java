...
public class Keys {
	...
	public static void main(final String[] args) throws Exception {
		...
		System.out.println("Any 404 or 401 errors are most likely due to incorrect URLs/OCIDs provided to this file: please double check these.\n");
		...
		// CREATE KEY
		String keyId = createKeyTest(kmsManagementClient, compartmentId, "SFLY_DELIVERABLES_TEST_KEYS");
